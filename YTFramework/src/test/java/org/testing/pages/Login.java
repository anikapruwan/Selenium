...
public class Login 
{
	...
	els.get(1).click();
			Thread.sleep(2000);
			driver.findElement(By.id(pr.getProperty("Login_2"))).sendKeys("anirudh.sharma@uolo.com");
		...
		w.until(ExpectedConditions.visibilityOf(el)).sendKeys("Anirudh@123");//sendKeys("Anirudh@123");
